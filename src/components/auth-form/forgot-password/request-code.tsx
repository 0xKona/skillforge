...
import { ForgotPasswordRequest, ResetPasswordForm } from "@/lib/form-schemas/auth-schema";
...
export default function RequestPasswordResetForm({
    ...
    const { isLoading, errorMsg, successMsg, setLoading, setErrorMsg, setSuccessMsg, setCodeSent, setProvidedEmail } = useRequestPasswordResetStore()
