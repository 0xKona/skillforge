module github.com/0xKona/skillforge/infra/lambda/ingot-handler

go 1.22

require (
	github.com/0xKona/skillforge/infra/lambda/shared v0.0.0
...
replace github.com/0xKona/skillforge/infra/lambda/shared => ../shared
